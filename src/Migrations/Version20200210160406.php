 ...
 */
final class Version20200210160406 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD creator_id INT NOT NULL, ADD site_id INT DEFAULT NULL, ADD place_id INT DEFAULT NULL, ADD status_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP creator_id, DROP site_id, DROP place_id, DROP status_id');
